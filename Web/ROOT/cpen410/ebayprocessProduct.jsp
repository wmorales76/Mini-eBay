        ...
        <%
            ...
            if ((session.getAttribute("userName") == null) || (session.getAttribute("currentPage") == null)) {
                ...
                try {
                    ...
                    boolean res = appDBManager.addProduct(userName, productName, productDescription, productPrice, productDate, productDepartment);
                    int lastprodId = 0;
                    if (res) {
                        // Get the last product id
                        ResultSet resprodId = appDBManager.getLastProductId();
                        if (resprodId.next()) {
                            // Create the product image
                            lastprodId = resprodId.getInt(1);
                            boolean imageres = appDBManager.addImage(productImage, lastprodId);
                        }
